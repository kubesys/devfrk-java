...
class ChunkedInputStream extends LeftOverInputStream {
	...
	/*
	 * read the chunk header line and return the chunk length any chunk extensions
	 * are ignored
	 */
	...
	/**
	 * returns the number of bytes available to read in the current chunk which may
	 * be less than the real amount, but we'll live with that limitation for the
	 * moment. It only affects potential efficiency rather than correctness.
	 */
