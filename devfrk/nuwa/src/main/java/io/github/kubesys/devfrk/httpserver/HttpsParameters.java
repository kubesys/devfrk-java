...
public abstract class HttpsParameters {
	...
	/**
	 * @return the address of the remote client initiating the connection.
	 */
	public abstract InetSocketAddress getClientAddress();

//BEGIN_TIGER_EXCLUDE
	/**
	 * Sets the SSLParameters to use for this HttpsParameters. The parameters must
	 * be supported by the SSLContext contained by the HttpsConfigurator associated
	 * with this HttpsParameters. If no parameters are set, then the default
	 * behavior is to use the default parameters from the associated SSLContext.
	 * 
	 * @param params the SSLParameters to set. If <code>null</code> then the
...
//END_TIGER_EXCLUDE
	 ...
	 * clears the <code>needClientAuth</code> flag.
	 *
	 ...
	 * clears the <code>wantClientAuth</code> flag.
	 *
