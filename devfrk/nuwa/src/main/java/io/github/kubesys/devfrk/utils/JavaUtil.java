...
public class JavaUtil {
	...
	public static boolean isInteger(String typename) {
		return Integer.class.getName().equals(typename) || "int".equals(typename);
	}
	...
	public static boolean isBoolean(String typename) {
		return Boolean.class.getName().equals(typename) || "boolean".equals(typename);
	}
