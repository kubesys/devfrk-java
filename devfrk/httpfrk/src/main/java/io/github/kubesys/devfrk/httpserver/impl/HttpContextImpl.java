...
import io.github.kubesys.devfrk.httpserver.Authenticator;
...
class HttpContextImpl extends HttpContext {
	...
	/**
	 * returns a mutable Map, which can be used to pass configuration and other data
	 * to Filter modules and to the context's exchange handler.
	 * <p>
