 ...
 * The keys are case-insensitive Strings representing the header names and the
 * value associated with each key is a {@link List}&lt;{@link String}&gt; with
 * one element for each occurrence of the header name in the request or
 * response.
 * <p>
 ...
 * lines: HeaderName: value1 HeaderName: value2
 * <p>
